...
# psb_learning/
APPS_DIR = ROOT_DIR / "psb_learning"
...
MIGRATION_MODULES = {"sites": "psb_learning.contrib.sites.migrations"}
...
DJANGO_APPS = [
    ...
    "psb_learning.users",  # Needs to go before something for template
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="psb_learning <noreply@e-kondr01.ru>"
)
SERVER_EMAIL = env("DJANGO_SERVER_EMAIL", default=DEFAULT_FROM_EMAIL)
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX",
    default="[psb_learning]",
)
